...
public class ScreenShotCapture {
	...
	public void captureSuccessScreenShot(WebDriver driver, String name) throws IOException {
		TakesScreenshot scrShot = (TakesScreenshot) driver;
		File screenShot = scrShot.getScreenshotAs(OutputType.FILE);

		File f1 = new File(System.getProperty("user.dir") + "\\OutputSuccessScreenshots");
		if (!f1.exists()) {
			f1.mkdirs();
		}
		...
		File finalDestination = new File(
				System.getProperty("user.dir") + "\\OutputSuccessScreenshots\\" + name + "_" + timeStamp + ".png");
