...
public class ExtenetReport implements ITestListener {
	...
	public void configureReport() {
		...
		reports.setSystemInfo("Project", "GroceryApp");
		reports.setSystemInfo("PC Name", "Abdul's PC");
		reports.setSystemInfo("OS", "Windows 11");
		reports.setSystemInfo("Test Done By", "Abdul Rahuman");		
		sparkReporter.config().setDocumentTitle("GroceryApp Report");
